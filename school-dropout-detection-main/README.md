...
├── data/
│   ├── raw/
│   │   ├── young_lives/     # Young Lives .dta files
│   │   └── kaggle/          # Education in Africa CSVs
│   └── processed/
│       ├── ethiopia_dropout_panel.csv      # Ready for modeling
│       └── ethiopia_constructed_full.csv   # Full 214 variables
├── src/
│   ├── config.py            # Configuration
│   ├── data_pipeline.py     # Data loading
│   ├── xgboost_model.py     # XGBoost classifier
│   ├── neural_ode.py        # Neural ODE with Lyapunov
...
Key Variables
Target Variable
dropout_next_round: 1 if child drops out in next survey round, 0 otherwise
Feature Categories
Category	Variables	Description
Education	enrol, engrade, hghgrade, preprim	Enrollment, grade level
Household	wi_new, hq_new, hhsize, ownhouse	Wealth, housing quality
